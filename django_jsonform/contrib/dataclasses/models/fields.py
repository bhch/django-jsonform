...
class DataclassJSONField(JSONField):
    def __init__(self, dataclass_cls:Type[JsonSchemaMixin],*,many:bool=False, **kwargs:Any)->None:
        self._dataclass_cls=dataclass_cls
        self._many=many
        self._json_schema=json_schema_array(dataclass_cls) if many else dataclass_cls.json_schema()
